...
import 'package:actividad_repaso_examen_eva2/views/HomeScreen.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'l10n/app_localizations.dart';
import 'package:sqflite_common_ffi/sqflite_ffi.dart'; // Windows 数据库支持
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => StudentViewModel(database)),
      ],
      child: const MyApp(),
    ),
  );
